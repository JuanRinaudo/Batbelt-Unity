...
namespace SimpleTweens
{
    ...
    public static class TweenManagerExtensions
    {
        ...
        public static Tween RunFixed(this TweenManager tweenManager, float start, float end, float duration, Action<float> updater, EaseProcedure procedure, Object? owner = null)
            => tweenManager.Run(start, end, duration, updater, procedure, BuiltInInterpolators.Float, owner, true);
        
        public static Tween RunFixed(this TweenManager tweenManager, Vector2 start, Vector2 end, float duration, Action<Vector2> updater, EaseProcedure procedure, Object? owner = null)
            => tweenManager.Run(start, end, duration, updater, procedure, BuiltInInterpolators.Vector2, owner, true);
        
        public static Tween RunFixed(this TweenManager tweenManager, Vector3 start, Vector3 end, float duration, Action<Vector3> updater, EaseProcedure procedure, Object? owner = null)
            => tweenManager.Run(start, end, duration, updater, procedure, BuiltInInterpolators.Vector3, owner, true);
        
        public static Tween RunFixed(this TweenManager tweenManager, Quaternion start, Quaternion end, float duration, Action<Quaternion> updater, EaseProcedure procedure, Object? owner = null)
            => tweenManager.Run(start, end, duration, updater, procedure, BuiltInInterpolators.Quaternion, owner, true);

        public static Tween Run<T>(this TweenManager tweenManager, T start, T end, float duration, Action<T> updater, EaseProcedure procedure, Interpolator<T> interpolator, Object? owner = null, bool fixedUpdate = false)
        {
